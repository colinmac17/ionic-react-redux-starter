...
import {selectTabOneTitle, changeTabOneTitle, changeTabTwoTitle, changeTabThreeTitle, changeTabTitleAsync} from "../features/tabs/tabSlice";
...
const ExploreContainer: React.FC<ContainerProps> = ({ name }) => {
  ...
  return (
    <div className="container">
      ...
      <IonInput value={text} color="dark" placeholder="enter new text" onIonChange={(e) => {
      ...
      }}>Make Title Uppercase</IonButton>
    </div>
  );
};
